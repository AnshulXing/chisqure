...
def realTime():
    ...
    while True:
        ...
        cv2.putText(img, "Motorbike:  "+"     "+ str(up_list[1]), (20, 60), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
        cv2.putText(img, "Bus:        "+"     "+ str(up_list[2]), (20, 80), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
        cv2.putText(img, "Truck:      "+"     "+ str(up_list[3]), (20, 100), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
        cv2.putText(img, "bicycle:      "+"     "+ str(up_list[3]), (20, 120), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
    ...
    with open("data.csv", 'w') as f1:
        ...
        cwriter.writerow(['Direction', 'car', 'motorbike', 'bus', 'truck','bicycle'])
        up_list.insert(0, "Up")
        up_list.insert(0, "Down")
